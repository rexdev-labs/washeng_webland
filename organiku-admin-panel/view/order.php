        ...
        <div class="element-wrapper">
            ...
            <div class="element-box">
                <h5 class="form-header">
                    Data Poduk Wpsc Store
                </h5>
                <div class="table-responsive">
                    <table class="table" data-show-toggle="false" data-expand-first="false" style="background: #fff; margin-bottom: 100px;">
                        <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama</th>
                        ...
                        <tbody>
                           <?php
                                    $data=$conn->query("SELECT * FROM produk ORDER BY id_produk DESC LIMIT 8");
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href=""><i class="icon-feather-trash-2"></i></a>
                                </td>
                                <td><?= $row[desk] ?></td>
                            </tr>
                            <?php
